...
class TelaContasAPagarState extends State<TelaContasAPagar> {
  ...
  void _sort<T>(
      Comparable<T> getField(Conta d), int columnIndex, bool ascending) {
          ...
          child: Row(
              ...
              children: <Widget>[
                CardTile(
                  ...
                  mainText: contas?.map<double>((c) => c.valor).reduce((a,b )=>a+b).toString(),
                ),
              ]));
  }
  ...
  IntrinsicHeight painelValorTotalAAbatido() {
    var total = contas?.map<double>((c) => c.valor).reduce((a,b)=>(a + b)) - 50;
    return IntrinsicHeight(
        child: Row(
            mainAxisAlignment: MainAxisAlignment.end,
            children: <Widget>[
    ...
    return Container(
        ...
        child: PaginatedDataTable(
          header: Row(
            ...
            children: <Widget>[insereContaContaButton(), filtro()],
          ),
...
//      });
  ...
  _orderDataTableColumns() {
    return <DataColumn>[
      ...
      DataColumn(
        label: const Text('Numero do Documento'),
        numeric: true
      ),
      DataColumn(
      ...
      DataColumn(
        ...
        onSort: (int columnIndex, bool ascending) =>
            _sort<String>((Conta d) => d.contaOrigem?.nome, columnIndex, ascending),
      ),
      DataColumn(
        label: const Text('Fornecedor'),
        onSort: (int columnIndex, bool ascending) =>
            _sort<String>((Conta d) => d.fornecedor?.nome, columnIndex, ascending),
      ),
      DataColumn(
